...
\citep{Phillips2022,TerraPower2021} and thermal-spectrum fluoride-cooled and
...
corpus; Mausolf and coworkers~\citep{Phillips2022} review the closest related
...
Horne et al.~\citep{KristoffersenMetiu2018}    & 2018 & NaCl, KCl, CsCl & \eS spectroscopy & --- & 0 & contextual \\
...
NaCl-UCl3 (op.\ MCFR)     & 60-40 mol\% & $\sim$590     & 600 (operational)                        & MCFR design~\citep{Phillips2022,TerraPower2021} \\
...
\item \emph{Oxide-impurity scavenging.}  Dissolved O$^{2-}$, OH$^-$, or
      ...
      \citep{Forsberg2020,CastroBaldivieso2026}.  Candidate channels include
...
\item \emph{Redox-active fission products.}  Cs$^+$/Cs$^0$ (volatile),
      ...
      minute-to-hour timescales~\citep{Briggs1964,CastroBaldivieso2026} and would
...
group's literature since 2018 \citep{KristoffersenMetiu2018}.
...
Panel~(n) of Figure~\ref{fig:master} shows a single representative
Cr$^{3+}$ trace.  Because the Iwamatsu~2026 dataset is the principal
transient-resolved anchor of the chloride kernel, we also reproduce all
nine Cr-transient absorbance curves in Figure~\ref{fig:cr_traces},
together with the corresponding posterior predictive median and 90\,\%
credible band.  The two traces marked as held-out (1~mM~Cr(III) and
3~mM~Cr(III)) were drawn at random before fitting and were excluded
from the inference; their experimental points nonetheless lie inside
the 90\,\% predictive band over the full time window, indicating that
the calibrated Arrhenius pairs and background-decay constant generalise
beyond the training subset.

\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{figures/fig_cr_traces.pdf}
...
\SI{400}{\celsius}~\citep{Iwamatsu2026}.  Each panel shows one
transient: the digitized experimental points, the posterior predictive
median (solid line) and the 90\,\% credible band (shaded).  Circles
mark training traces; triangles mark the two held-out validation
traces (1~mM~Cr(III) and 3~mM~Cr(III)).  Cr(II) panels are coloured
blue; Cr(III) panels vermillion.  Held-out residuals lie within the
90\,\% interval at every sampled time.}
\label{fig:cr_traces}
\end{figure}
...
\citep{Phillips2022,TerraPower2021,TerraPower2021}; the Phillips~2022
...
\item Notional engineering screening threshold on cover-gas Cl$_2$:
      ...
      \citep{Sohal2010,Carotti2017,Forsberg2020}.  These thresholds
...
\item \emph{Multi-source calibration subset.}  The likelihood-bearing
      ...
      sources simultaneously; Mausolf et al.~\citep{Phillips2022} review
...
\item \emph{Quantitative inter-facility bias resolution.}  The
      ...
      \citep{KristoffersenMetiu2018,Iwamatsu2022} but had no formal Bayesian treatment.
...
Horne 2018~\citep{KristoffersenMetiu2018}                  &  --- & contextual (no likelihood entry) \\
